...
--
-- Host: localhost    Database: locker-system_development
-- ------------------------------------------------------
...
CREATE TABLE `lockers` (
  ...
  `lockerNumber` int(11) NOT NULL DEFAULT '0',
  `location` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `combo` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`,`lockerNumber`)
...
CREATE TABLE `registrations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `numberOfSemester` int(11) DEFAULT NULL,
...
INSERT INTO `schema_migrations` VALUES ('20141124004021'),('20141124020136'),('20141124021003'),('20141124021434');
...
-- Dump completed on 2014-11-23 22:30:22
