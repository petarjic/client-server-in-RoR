...
class LockersControllerTest < ActionController::TestCase
  ...
  test "should create locker" do
    assert_difference('Locker.count') do
      post :create, locker: { combo: @locker.combo, location: @locker.location, lockerNumber: @locker.lockerNumber, type: @locker.type }
    end
  ...
  test "should update locker" do
    patch :update, id: @locker, locker: { combo: @locker.combo, location: @locker.location, lockerNumber: @locker.lockerNumber, type: @locker.type }
    assert_redirected_to locker_path(assigns(:locker))
  end
